...
const zh: Record<string, string> = {
  ...
  "Quick quote": "快速询价",
  "General enquiry": "普通咨询",
  "Home / International Trade": "首页 / 国际采购",
  "International Procurement": "国际采购导览",
  "A clear route from product selection to confirmed export quotation.": "从产品选择到出口报价确认的清晰流程。",
  "How it works": "采购流程",
  "Built for project and wholesale enquiries.": "面向工程项目与批量采购。",
  "This website is a quotation platform, not an instant-payment store. Product availability, technical specifications, pricing, packing, shipping and payment terms are confirmed in a formal quotation before any order is placed.": "本网站用于提交询价，并非即时付款商城。产品供应、技术规格、价格、包装、运输和付款条款均会在下单前通过正式报价确认。",
  "Select products": "选择产品",
  "Add models and required quantities to your quote list.": "将所需型号和数量加入询价清单。",
  "Confirm specifications": "确认规格",
  "Our sales team checks size, finish, packaging, MOQ and production availability.": "销售团队将确认尺寸、表面工艺、包装、起订量和生产情况。",
  "Receive quotation": "接收报价",
  "The formal quotation confirms price, Incoterm, lead time, validity and payment terms.": "正式报价将确认价格、贸易术语、交期、有效期和付款条款。",
  "Approve production": "确认生产",
  "Samples, colour references and order details are confirmed before production where applicable.": "如有需要，将在生产前确认样品、颜色参照和订单细节。",
  "Inspection & shipment": "验货与发运",
  "Packing, inspection documents and shipping arrangements are coordinated against the confirmed contract.": "包装、验货文件和运输安排将按照已确认合同协调执行。",
  "Quotation checklist": "报价确认内容",
  "Information confirmed for every project.": "每个项目都会确认的关键信息。",
  "Product & packing": "产品与包装",
  "Model, dimensions, finish, colour variation, quantity per carton or pallet, gross weight and packing method are confirmed by product.": "根据具体产品确认型号、尺寸、表面工艺、色差、每箱或每托数量、毛重和包装方式。",
  "MOQ & lead time": "起订量与交期",
  "Minimum order quantity, sample availability, production schedule and estimated readiness date are confirmed by the sales team.": "起订量、样品供应、生产计划和预计备货日期由销售团队确认。",
  "Delivery terms": "运输条款",
  "Available Incoterms, named port or destination, freight scope, insurance and customs responsibilities are stated in the quotation.": "可用贸易术语、指定港口或目的地、运费范围、保险和清关责任将在报价中注明。",
  "Commercial documents": "贸易文件",
  "Quotation validity, payment milestones and applicable packing, inspection and shipping documents are agreed before order confirmation.": "报价有效期、付款节点以及适用的包装、验货和运输文件将在订单确认前商定。",
  "No unverified promises": "不提供未经确认的承诺",
  "MOQ, delivery time, certifications and trade terms vary by model and destination. Where these details are not published, the website marks them for sales confirmation rather than presenting assumed information.": "起订量、交期、认证和贸易条款会因型号与目的地而异。未公开的信息将明确标注为由销售确认，不展示未经核实的内容。",
  "Build a quote list": "建立询价清单",
  "International project sourcing": "国际工程采购",
  "How to purchase from Huangjia": "如何向皇家建材采购",
  "This page explains how overseas distributors, project teams and wholesale buyers move from product selection to a confirmed quotation and delivery arrangement.": "本页面说明海外经销商、工程团队和批量采购客户如何从选择产品进入正式报价与交付安排。",
  "Open quote list": "打开询价清单",
  "Purpose of this page": "本页用途",
  "A clear route from selection to quotation.": "从选品到报价的清晰路径。",
  "Huangjia supplies building materials through project and wholesale enquiries. The website helps you select products and prepare one complete request. It does not take instant online payment. Final specifications, availability, price, packing and shipping terms are confirmed in writing before an order is placed.": "皇家建材通过工程与批量询价方式供应建材。本网站帮助您选择产品并整理一份完整需求，不进行即时在线付款。最终规格、供应情况、价格、包装和运输条款将在下单前以书面形式确认。",
  "Purchasing process": "采购流程",
  "Five steps from enquiry to delivery.": "从询价到交付的五个步骤。",
  "Choose products": "选择产品",
  "Browse the catalogue and add the required models and estimated quantities to one quote list.": "浏览产品目录，将所需型号和预计数量加入同一份询价清单。",
  "Send project details": "提交项目需求",
  "Tell us the destination market, required sizes, finish, quantity and preferred delivery time.": "告知目的市场、所需尺寸、表面工艺、数量和期望交付时间。",
  "Our team checks availability, packing, MOQ, lead time and any technical requirements with you.": "我们的团队将与您确认供应、包装、起订量、交期和技术要求。",
  "Receive a formal quotation": "接收正式报价",
  "The quotation records confirmed products, pricing, trade terms, production schedule and validity.": "报价单将记录已确认的产品、价格、贸易条款、生产计划和有效期。",
  "Approve and coordinate delivery": "确认并协调交付",
  "After commercial terms are accepted, production, inspection documents and shipment are coordinated.": "商业条款接受后，将协调生产、验货文件和运输安排。",
  "Before requesting a quote": "询价前准备",
  "Prepare these four details.": "准备以下四项信息。",
  "Complete information helps the sales team check the correct product and respond more efficiently.": "完整的信息能帮助销售团队确认正确产品并更高效地回复。",
  "Model number, size, finish and estimated quantity": "型号、尺寸、表面工艺和预计数量",
  "Project": "项目信息",
  "Application, destination country and required date": "应用场景、目的国家和需求日期",
  "Delivery": "交付信息",
  "Preferred port, address or requested Incoterm, if known": "如已确定，请提供首选港口、地址或贸易术语",
  "Documents": "文件要求",
  "Any certification, packing or inspection requirements": "认证、包装或验货要求",
  "Clear commercial confirmation": "清晰的商业确认",
  "Only confirmed information enters the quotation.": "仅将确认后的信息写入报价。",
  "MOQ, lead time, certification, packing and delivery terms vary by product and destination. Our team confirms these details for your project instead of presenting assumptions.": "起订量、交期、认证、包装和交付条款会因产品与目的地而异。我们的团队会针对您的项目确认这些信息，不提供未经核实的假设。",
  "Start with the product catalogue": "从产品目录开始",
  "Add to Quote": "加入询价清单",
  ...
  "Popular": "热门分类",
  "Continue to contact details": "下一步：填写联系信息",
  "Back to products": "返回确认产品",
  "View quote list": "查看询价清单",
  "Browse products, build one quote list, then send it to our sales team.": "浏览产品，建立一份询价清单，再统一发送给销售团队。",
  "Foshan · China": "中国 · 佛山",
  ...
  "Get a quote": "获取报价",
  "Quick project quote": "快速项目询价",
  "Tell us what you need.": "告诉我们您的需求。",
  "Send the product model, quantity and destination. Our sales team will prepare a confirmed quotation.": "提交产品型号、数量和目的地，我们的销售团队将为您准备正式报价。",
  "Products and quantity *": "产品与数量 *",
  "Model, quantity, specifications and delivery date…": "产品型号、数量、规格和交付日期……",
  "Send quick quote": "发送快速询价",
  "Or email us directly at": "或直接发送邮件至",
